...
class GenerateKeys():
    def __init__(self):
        primes = []
        with open("primes-500-to-1k.txt", "r") as fl:
...
window.iconbitmap("RSA Icon.ico")
...
senderFrame = tk.LabelFrame(window, bd=5, bg="#9CA9FA", text = "Sender", font = ("Rockwell", 23), labelanchor = "n", padx=10, pady=10, width=625)
...
filler.pack(side = tk.LEFT, fill = tk.X)
enter = tk.Button(keysFrame, text = "Enter", font = "Helvetica 10 bold", fg="#000000", bg="#6E81F7", padx=20, pady=1, relief = tk.GROOVE, cursor = "hand2",
